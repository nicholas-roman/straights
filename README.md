...
this game, the Ace is considered to be the lowest card in each suit (rank of 1), while the King is the highest (rank of 13).
...
the end of a round, then the deck is reshuffled and another round begins. Note that the game does not end early since points
are only scored at the end of the round, thus the game won’t know if someone has reached 80 or more points until the round
ends.
